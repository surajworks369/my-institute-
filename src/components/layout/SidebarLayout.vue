<template>
  <!-- Sidebar: main navigation (desktop + mobile) -->
  <aside :class="['sidebar', { collapsed, 'mobile-open': mobileOpen, 'mobile-mode': isMobile }]">
    ...
    <div class="sidebar-menu-scroll">
      ...
      <nav class="menu">
        ...
        <!-- Academic group: Students / Courses / Batches / Attendance / Exams -->
...
// Mount: initial responsive check + resize listener
onMounted(() => {
  checkMobile()
