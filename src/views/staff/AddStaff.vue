      ...
      <form class="staff-form" @submit.prevent="submitForm">
        <div class="form-grid">
          <div class="form-group">
            ...
            <input v-model.trim="form.staffCode" class="form-control" placeholder="e.g. STF-1022" />
          ...
          <div class="form-group">
            ...
            <small v-if="errors.gender" class="error-text">{{ errors.gender }}</small>
          </div>
          ...
          <div class="form-group full-width">
            <label>Address</label>
            <input v-model.trim="form.address" class="form-control" placeholder="Enter address" />
          ...
          <div class="form-group full-width">
            ...
            <textarea
              ...
              placeholder="Optional notes about staff member"
            ></textarea>
          </div>
        </div>
        ...
        <div class="form-actions">
          ...
          <button type="submit" class="app-btn app-btn-primary">Save Staff</button>
        </div>
      </form>
    </div>
  </div>
...
type FormErrors = Partial<Record<keyof StaffCreateInput, string>>
...
const initialForm = (): StaffCreateInput => ({
  staffCode: '',
  fullName: '',
  email: '',
  phone: '',
...
const form = reactive<StaffCreateInput>(initialForm())
